...
- **상태**: 노트북의 상태가 표시됩니다. 주요 상태는 아래 표를 참고해 주세요.
    ...
    | FAILED TO CREATE RESOURCES | 노트북 생성 중 실패한 상태입니다. 생성이 지속적으로 실패하면 고객 센터로 문의해 주세요. |
    | FAILED TO STOP | 노트북 중지를 실패한 상태입니다. 다시 시도해 주세요. |
    | FAILED TO START | 노트북 시작을 실패한 상태입니다. 다시 시도해 주세요. |
    | FAILED TO DELETE | 노트북 삭제를 실패한 상태입니다. 다시 시도해 주세요. |
...
- **상태**: 학습의 상태가 표시됩니다. 주요 상태는 아래 표를 참고해 주세요.
    ...
    | FAILED TO TRAIN | 학습 진행 중 실패한 상태입니다. 자세한 실패 정보는 로그 관리가 활성화된 경우, Log & Crash Search 로그를 통해 확인할 수 있습니다. |
    | FAILED TO CREATE RESOURCES | 학습 생성을 실패한 상태입니다. 생성이 지속적으로 실패하면 고객 센터로 문의해 주세요. |
    | FAILED TO CLEAR RESOURCES | 학습에 사용된 자원이 정상적으로 삭제되지 못한 상태입니다. 다시 시도해주세요. |
    | FAILED TO STOP | 학습 중지를 실패한 상태입니다. 다시 시도해 주세요. |
    | FAILED TO DELETE | 학습 삭제를 실패한 상태입니다. 다시 시도해 주세요. |
...
- **상태**: 엔드포인트의 상태입니다. 주요 상태는 아래 표를 참고해 주세요.
    ...
    | FAILED TO CREATE RESOURCES | 엔드포인트 생성에 실패한 상태입니다.<br/>엔드포인트를 삭제 후 다시 생성해야 합니다. 생성 실패 상태가 반복되면 고객 센터로 문의해 주세요. |
...
- **상태**: 엔드포인트 스테이지의 상태가 표시됩니다. 주요 상태는 아래 표를 참고해 주세요.
    ...
    | FAILED TO CREATE RESOURCES |  엔드포인트 스테이지 생성에 실패한 상태입니다. 다시 시도해 주세요. |
    | FAILED TO CLEAR RESOURCES |  엔드포인트 스테이지 삭제에 실패한 상태입니다. 다시 시도해 주세요. |
    | FAILED TO MODEL DEPLOY |  엔드포인트 스테이지 배포에 실패한 상태입니다. 다시 생성을 시도해 주세요. |
