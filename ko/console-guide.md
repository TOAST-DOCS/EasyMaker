...
- **실행 정보**
    ...
    - **실행 유형**: 파이프라인 실행 유형을 선택합니다. **일회성**을 선택한 경우 파이프라인을 한 번만 실행합니다. 파이프라인을 주기적으로 반복 실행하려면 **일정 설정**을 선택한 후 [파이프라인 일정 생성](./console-guide/#_81)을 참고하여 일정을 구성하세요.
- **인스턴스 정보**
...
파이프라인 일정 생성에 설정할 수 있는 정보 중 아래 항목 외 정보는 [파이프라인 실행 생성](./console-guide/#_74)을 참고하세요.
