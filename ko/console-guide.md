...
권한을 추가하는 작업은 AI EasyMaker 시스템 계정이 사용자의 NHN Cloud Object Stroage의 데이터를 읽거나 쓸수 있도록 권한을 허용하는 작업입니다.
AI EasyMaker 시스템 계정 정보가 외부로 노출되지 않도록 유의해주시고, 접근이 허용될 NHN Cloud Object Stroage에만 권한을 적용하시기 바랍니다.
...
4. [특정 프로젝트 또는 특정 사용자에게 읽기/쓰기 허용](https://docs.toast.com/ko/Storage/Object%20Storage/ko/acl-guide/#_4) 문서를 참고하여 NHN Cloud Object Storage 콘솔에서 EasyMaker 시스템 계정의 읽기/쓰기 허용 권한을 추가합니다.
