...
- **추가 설정**
    ...
    - **최대 학습 시간**: 학습이 완료될 때까지 최대 대기 시간을 지정합니다. 최대 대기 시간을 초과한 학습은 종료 처리됩니다.
...
- **추가 설정**
    ...
    - **최대 진행 시간**: 파인 튜닝이 완료될 때까지 최대 대기 시간을 지정합니다. 최대 대기 시간을 초과한 파인 튜닝은 종료 처리됩니다.
...
- **추가 설정**
    ...
    - **최대 배치 추론 시간**: 배치 추론이 완료될 때까지 최대 대기 시간을 지정합니다. 최대 대기 시간을 초과한 배치 추론은 종료 처리됩니다.
...
!!! tip "알아두기"
    ...
    파이프라인 코드의 로그는 [SDK의 Log 전송 기능](./sdk-guide/#feature.lncs.log.send)을 이용하여 Log & Crash Search로 전송하여 확인하세요.
