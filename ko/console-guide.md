...
- **모델 정보**: 평가할 모델의 정보를 입력합니다.
  ...
  - **평가 예측 레이블 필드**: 분류 모델에서 예측 결과 값이 있는 필드 이름을 입력합니다.
  - **평가 예측 점수 필드**: 예측 점수의 필드 이름을 입력합니다.
  - **특성 중요도**: 특성 중요도를 측정할지 여부를 설정합니다.
- **모델 평가 인스턴스 정보**
...
- **추가 설정**
  - **부트 스토리지 크기**: 모델 평가를 실행할 인스턴스의 부트 스토리지 크기를 입력합니다.
  - **데이터 스토리지 크기**: 모델 평가를 실행할 인스턴스의 데이터 스토리지 크기를 입력합니다.
...
- **작업**
  - **모델 평가 중지**: 진행 중인 모델 평가를 중지할 수 있습니다.
