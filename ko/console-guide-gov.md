...
- **스토리지**
    - 노트북의 부트 스토리지와 데이터 스토리지 크기를 지정합니다.
        ...
        - 데이터 스토리지는 `/root/easymaker` 디렉터리 경로에 마운트되는 블록 스토리지입니다. 이 스토리지의 데이터는 노트북을 재시작해도 유지됩니다.
...
- **학습 템플릿**
    ...
    - **학습 템플릿**: 하이퍼파라미터 튜닝의 일부 구성 값을 자동으로 입력하는 데 사용할 학습 템플릿을 선택합니다.
- **기본 정보**
...
!!! tip "알아두기"
    ...
    - 하나의 샘플(한 줄)의 최대 길이는 5120 토큰입니다. 최대 길이를 초과하는 샘플은 학습에서 제외됩니다.
