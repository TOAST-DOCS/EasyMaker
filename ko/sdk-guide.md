...
| generate_feature_attributions             | Boolean | 선택    | False  | True, False                                     | 모델에 대한 설명                                                       |
| instance_name                             | String  | 필수    | 없음    | 없음                                              | 모델에 대한 설명                                                       |
| input_data_uri                            | String  | 필수    | 없음    | 최대 255자                                         | 모델에 대한 설명                                                       |
| input_data_type_code                      | String  | 필수    | 없음    | 최대 255자                                         | 모델에 대한 설명                                                       |
| target_field_name                         | String  | 필수    | 없음    | 최대 255자                                         | 모델에 대한 설명                                                       |
