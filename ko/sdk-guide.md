...
인증 토큰(access token) 설명은 [User Access Key 토큰](https://docs.{% if "gov" in build_flags %}gov-{% endif %}nhncloud.com/ko/nhncloud/ko/public-api/user-access-key-token{% if "gov" in build_flags %}-gov{% endif %}/)에서 확인할 수 있습니다.
